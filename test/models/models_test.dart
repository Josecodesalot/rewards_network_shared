...
import 'package:rewards_network_shared/models/admin.dart';
import 'package:rewards_network_shared/models/clerk.dart';
import 'package:rewards_network_shared/models/client.dart';
import 'package:rewards_network_shared/models/master.dart';
...
void main() {
  ...
  test('Objects Should be intiialized with the right defaults', () {
